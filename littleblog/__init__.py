"""
Exports a function to create an instance of the LittleBlog app.
"""
...
from littleblog.assets import bundles
from littleblog.helpers import markdown_to_html
...
def create_app(testing=False):
    """
    Creates an instance of the LittleBlog app.
    """
    ...
    # register blueprints
    from littleblog.blueprints.home import home
    from littleblog.blueprints.post import post
    from littleblog.blueprints.search import search
    from littleblog.blueprints.user import user
